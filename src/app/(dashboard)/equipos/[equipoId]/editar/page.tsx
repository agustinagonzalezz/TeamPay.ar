...
// Este componente recibe los datos actuales del equipo como props
// desde el Server Component wrapper de abajo
...
function EditarEquipoForm({ equipoId, nombre, descripcion }: EditarEquipoFormProps) {
